...
static const char col_base[] 		= "#121212";
static const char col_purple[]      = "#512da8";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_base, col_gray2 },
	[SchemeSel]  = { col_gray4, col_base,  col_purple  },
};
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_Return, zoom,           {0} }, // move selected window to master view
